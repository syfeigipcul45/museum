                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card my-2">
                                <label for="imageHero" class="mb-0 cursor-pointer">
                                    @if($hero_image->link_hero)
                                    <img id="image-hero" class="card-img-top" src="{{ $hero_image->link_hero }}" alt="Card image cap">
                                    <input type="hidden" name="old_link_hero" value="{{ $hero_image->link_hero }}" />
                                    @else
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Judul</label>
                                <input type="text" class="form-control" name="judul" value="{{ old('judul', $hero_image->judul) }}" />
                                @error('judul')
                                <small class="form-text error-input">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card my-2">
                                <label for="imageUpload" class="mb-0 cursor-pointer">
                                    ...
                                    <img id="image-preview" class="card-img-top" src="{{ $hero_image->link_image }}" alt="Card image cap">
                                    <input type="hidden" name="old_link_image" value="{{ $hero_image->link_image }}" />
                                    @else
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="deskripsi" id="deskripsi" onkeyup="countChars(this);">{{ old('deskripsi', $hero_image->deskripsi) }}</textarea>
                                <p id="charNum"></p>
                                @error('deskripsi')
                                <small class="form-text error-input">{{ $message }}</small>
                                @enderror
