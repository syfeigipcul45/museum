    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="title" value="{{ old('title', $berita->title) }}" />
                        @error('title')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-berita" name="content">{{ old('content', $berita->content) }}</textarea>
                    @error('content')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" id="status" class="custom-control-input" {{ $berita->is_published == 1 ? 'checked' : '' }} />
                            <input type="hidden" id="status-value" name="is_published" value="{{ old('is_published', $berita->is_published) }}" />
                    ...
                    <div>
                        ...
                        <div class="card my-2">
                            <label for="imageUpload" class="mb-0 cursor-pointer">
                                @if($berita->link_media)
                                <img id="image-preview" class="card-img-top" src="{{ $berita->link_media }}" alt="Card image cap">
                                <input type="hidden" name="old_link_media" value="{{ $berita->link_media }}" />
                                @else
...
<script>
    ...
    tinymce.init({
        selector: 'textarea#content-berita',
