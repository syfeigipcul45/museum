    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="date" class="form-control" name="tanggal_agenda" value="{{ old('tanggal_agenda') }}" />
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-events" name="content">{{ old('content') }}</textarea>
                    @error('content')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
...
<script>
    ...
    tinymce.init({
        selector: 'textarea#content-events',
