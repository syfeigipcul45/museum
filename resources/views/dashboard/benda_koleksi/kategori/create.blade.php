...
<form action="{{ route('dashboard.kategori_koleksi.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Nama Kategori Benda Koleksi</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-desc" name="deskripsi">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
...
<script>
    ...
    tinymce.init({
        selector: 'textarea#content-desc',
