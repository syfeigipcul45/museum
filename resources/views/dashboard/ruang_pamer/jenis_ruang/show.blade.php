    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_jenis" value="{{ old('name', $jenis_ruang->nama_jenis) }}" readonly/>
                        @error('name')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="imageWrapper" class="row">
                        @foreach(json_decode($jenis_ruang->link_media) as $key => $item)
                        <div class="col-sm-3">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-desc" name="deskripsi">{{ old('deskripsi', $jenis_ruang->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
