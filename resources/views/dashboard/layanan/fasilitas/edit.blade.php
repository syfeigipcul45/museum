...
@section('title')
Edit Submenu {{ $fasilitas->nama_judul }}
@endsection
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_judul" value="{{ old('nama_judul', $fasilitas->nama_judul) }}" />
                        @error('nama_judul')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="icon" placeholder='<i class="fa-solid fa-mosque"></i>' value='{!! $fasilitas->icon !!}'/><br>
