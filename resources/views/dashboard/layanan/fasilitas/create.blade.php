            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_judul" value="{{ old('nama_judul') }}" />
                        @error('nama_judul')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="icon" value="{{ old('icon') }}" placeholder='<i class="fa-solid fa-mosque"></i>'/>
                        @error('icon')
                        <small class="form-text error-input">{{ $message }}</small>
                        @enderror
                    </div>
