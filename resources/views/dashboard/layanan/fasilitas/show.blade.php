...
@section('title')
Lihat Menu {{ $fasilitas->nama_judul }}
@endsection
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Nama Menu</h6>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_judul" value="{{ old('nama_judul', $fasilitas->nama_judul) }}" readonly/>
                        @error('nama_judul')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <span style="font-size: small; color: red;">*icon dapat dilihat di website ini <a href="https://fontawesome.com/icons" target="_blank">https://fontawesome.com/icons</a></span>
                        <input type="text" class="form-control" name="icon" placeholder='<i class="fa-solid fa-mosque"></i>' value='{!! $fasilitas->icon !!}' readonly/><br>
                        <h1>{!! $fasilitas->icon !!}</h1>
                        @error('icon')
                        <small class="form-text error-input">{{ $message }}</small>
                        @enderror
                    </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div id="imageWrapper" class="row">
                        @foreach(json_decode($fasilitas->link_media) as $key => $item)
                        <div class="col-sm-3">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-fasilitas" name="deskripsi">{{ old('deskripsi', $fasilitas->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
