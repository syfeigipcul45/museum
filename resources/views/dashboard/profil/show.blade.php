    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" class="form-control" name="submenu" value="{{ old('submenu', $profil->submenu) }}" readonly/>
                        @error('submenu')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <textarea id="content-profil" name="deskripsi">{{ old('deskripsi', $profil->deskripsi) }}</textarea>
                    @error('deskripsi')
                    <small class="form-text error-input">{{ $message }}</small>
                    @enderror
                </div>
